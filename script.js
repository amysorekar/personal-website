...
function showBubble(content) {
  ...
  if (content === "Smoothie King") {
    ...
    bubbleContent.textContent = "It was time for the big leagues! I had done the traditional research lab, I had done the behavioral research, now it was time to step it up. MD Anderson, one of the world's biggest cancer centers, is located 20 minutes from my home in Houston, Tx. The school year prior to this summer, I had taken my first batch of coding classes and was quite enjoying it. I wasn't ready to make the full switch to a field such as software engineering, but I wanted to hone my skills on something new, but familiar. I went to the MD Anderson website, perused through the departments, and emailed every single PI in the computational biology department. I sent 10 emails. 5 no-responses, 4 'sorry but...' and 1 interview. I knew I had to nail this interview or I'd be out of luck. I went in and conquered! I was offered a job on the spot. This was a huge step for me as I'd never done a coding related job or worked with genetics and dna before! The summer was an overall success. I learned a lot about what it was like to work in a computational biology lab, and I learned a lot about coding. This is was a necessary step in my career path in terms of narrowing down what I actually wanted to do in life. ";
  }
  ...
  if (content === "Smoothie King ") {
    ...
    bubbleContent.textContent = "I learned about the Massive Parallel Reporter Assay (MPRA) and investigated how the MPRA data is structured and analyzed; I translated the MPRA Oligo Barcode Pipeline (R and Perl) and the MPRA model pipeline (R) into pseudo code for ease of understanding; I gave presentations on the fundamentals of MPRAs, how MPRA data is presented, and different methods of analysis used to extract meaning from the MPRA results; I collaborated with an external bioinformatics research lab to optimize and debug the MPRA pipeline; I used the MPRA pipeline to generate gene expression results of datasets retrieved from ENCODE genomics library; I wrote code to streamline the process of running datasets through the pipeline from the users computer.";
  }
